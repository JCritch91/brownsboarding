  ...
  try {
    ...
    if (
      ...
      return NextResponse.json(
        {
          error:
            "You do not have permission to add dogs for customers.",
        },
        {
          status: 403,
        }
    ...
    if (!customer.active) {
      return NextResponse.json(
        {
          error:
            "A dog cannot be added to an inactive customer account.",
        },
        {
          status: 409,
        }
    ...
    const body =
      (await request.json()) as CreateAdminDogRequest;
    ...
    if (
      typeof body.meetAndGreetCompleted !==
      "boolean"
    ) {
      return NextResponse.json(
        {
          error:
            "The Meet & Greet completion status is invalid.",
        },
        {
          status: 400,
        }
    ...
    return NextResponse.json(
      {
        ...
        message:
          "The dog has been added successfully.",
      },
      {
        status: 201,
      }
    ...
    console.error(
      "Admin customer dog creation failed:",
      error
    );
