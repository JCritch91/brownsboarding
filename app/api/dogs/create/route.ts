  ...
  try {
    ...
    if (!accessToken) {
      return NextResponse.json(
        {
          error: "You must be signed in to add a dog.",
        },
        {
          status: 401,
        },
    ...
    if (!profile.active) {
      return NextResponse.json(
        {
          error: "A dog cannot be added to an inactive account.",
        },
        {
          status: 403,
        },
    ...
    return NextResponse.json(
      {
        ...
        dog: {
          ...
          name: dog.name,
          active: dog.active,
          meetAndGreetCompleted: dog.meet_and_greet_completed,
        },
        message: "Your dog has been added successfully.",
      },
      {
        status: 201,
      },
    ...
    console.error("Customer dog creation failed:", error);
