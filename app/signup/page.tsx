...
const activationResponse = await fetch("/api/prepare-account-activation", {
  method: "POST",
  headers: {
...
if (!activationResponse.ok) {
  ...
  setMessage(
    activationResult.error ||
      "Account created, but the activation email could not be sent. Please contact Browns Boarding."
  );
